...
# -*- coding: utf-8 -*-
"""
Graph Neural Network for California-internal flight risk prediction (binary classification)
...
# Argument parser
# ================================================================
parser = argparse.ArgumentParser(description="Train GNN on California flight network")
parser.add_argument("--data_root", type=str, required=True,
                    help="Root directory containing flight data (e.g. /projectnb/vipcnns/Boyang_GNN/flight_data)")
...
# ================================================================
# 1. Load all CSV files (multiple years)
# ================================================================
...
# ================================================================
# 2. Filter California-internal flights
# ================================================================
...
# ================================================================
# 4. Build nodes and node features
# ================================================================
...
# ================================================================
# 5. Build edges and edge features
# ================================================================
...
edge_feature_cols = ["DISTANCE", "CRS_DEP_TIME", "CRS_ARR_TIME", "ACTUAL_ELAPSED_TIME", "AIR_TIME", "CARRIER_LE"]
...
class FlightGNN(nn.Module):
    def __init__(self, in_node_dim, edge_attr_dim):
        super().__init__()
        self.conv1 = GCNConv(in_node_dim, 64)
        self.conv2 = GCNConv(64, 64)
        self.mlp = nn.Sequential(
            nn.Linear(64*2 + edge_attr_dim, 128),
            nn.ReLU(),
            nn.Dropout(0.2),
            nn.Linear(128, 64),
            nn.ReLU(),
